...
import numpy as np 
import dagshub
dagshub.init(repo_owner='AnupDangi', repo_name='NetworkSecurityMLOPSProject', mlflow=True)
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)-> ModelTrainerArtifact:
        try:
            logging.info("Entered the initiate model")
            ...
            logging.info("Loaded the training and testing array")
    ...
    def track_mlflow(self,best_model,classification_metric):
        try:
            logging.info("Tracking the experiment with mlflow")
