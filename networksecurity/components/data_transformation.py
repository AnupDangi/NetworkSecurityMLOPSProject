...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """
            It initiates a KNNImputer object with the parameter specified in the training_pipeline.py file ann returns a pipeline object with the KNNImputer object as the first step.
        """
        logging.info("Entered the data_transformation_object method of Transformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRASFORMATION_IMPUTER_PARAMS)
            logging.info(
                f"Entered initiate_data_transformation_objct method of Transformation data"
            )   
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            logging.info("Reading the data transformation")
